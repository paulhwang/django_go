...
import go_server.fibre_folder.cluster_mgr

def malloc(root_val):
    return FibreClass(root_val)

def malloc_link_mgr(root_val):
    return go_server.fibre_folder.link_mgr.malloc(root_val)

def malloc_session_mgr(root_val):
    return go_server.fibre_folder.session_mgr.malloc(root_val)

def malloc_cluster_mgr(root_val):
    return go_server.fibre_folder.cluster_mgr.malloc(root_val)
